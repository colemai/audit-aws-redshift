...
coreo_aws_advisor_alert "redshift-encrypted" do
  ...
  display_name "Redshift cluster data is not encrypted at rest"
...
coreo_aws_advisor_alert "redshift-no-require-ssl" do
  ...
  display_name "Redshift connections not SSL"
...
coreo_aws_advisor_alert "redshift-no-user-logging" do
  ...
  display_name "Redshift user activity logging disabled"
